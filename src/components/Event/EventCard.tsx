  ...
  return (
    ...
    >
      ...
      <figure className="relative h-64 overflow-hidden">
        ...
        {/* Category */}
        <div className="absolute top-4 right-4 bg-primary text-white px-3 py-1 rounded-full text-xs font-semibold shadow-sm">
          {category}
        </div>
      </figure>
      ...
      <div className="card-body p-8">
        ...
        <div className="card-actions mt-auto">
          <Link
            to={`/event/${event._id}`}
            className=" btn btn-outline btn-block rounded-full border-base-300 hover:bg-primary hover:text-white hover:border-transparent transition-all"
          >
            Book Ticket
            <svg
              xmlns="http://www.w3.org/2000/svg"

...
const ProfileCard = () => {
  ...
  const currentTheme = roleTheme[user.role as keyof typeof roleTheme] || roleTheme.user;
          ...
          <div className="mt-10 space-y-3">
            ...
            {user.role === "user" && (
              <button
                ...
                className={`w-full py-4 cursor-pointer px-4 text-sm font-bold rounded-xl transition-all duration-300 flex items-center justify-center gap-2 ${user.status === "requested"

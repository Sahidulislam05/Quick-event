...
const AllEvents = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4">
      <Heading className="text-slate-800 text-4xl text-center font-extrabold pt-[120px]">
        Available Events
      </Heading>
      ...
      <Suspense fallback={<div className="grid grid-cols-1 md:grid-cols-3 gap-8 py-12">{[...Array(6)].map((_, i) => <EventCardSkeleton key={i} />)}</div>}>
        {isLoading ? (
              ...
              <div className="flex justify-center gap-2 mb-10 flex-wrap">
                ...
                {[...Array(totalPages).keys()].map((page) => (
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg font-medium transition-all ${currentPage === page + 1

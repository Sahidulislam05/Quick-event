...
const EventDetails = () => {
  ...
  const { data: event = {} as IEvent, isLoading } = useQuery({
    queryKey: ["events", id],
    queryFn: async () => {
  ...
  const isBooked = !!(myBookings as IBooking[]).find(
    (b: IBooking) => String(b.eventId) === String(event?._id) && b.status === "confirmed"
  );
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-8 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between py-3">
                  ...
                  <span
                    className={`px-3 py-1 rounded-full text-sm font-medium ${event.availableSeats > 0
              ...
              <button
                ...
                className={`w-full py-4 cursor-pointer rounded-xl font-semibold text-lg transition-all duration-300 ${isBooked || event.availableSeats <= 0
